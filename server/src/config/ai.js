...
ВАЖНО: Отвечай ТОЛЬКО на русском языке! Используй исключительно русские слова и термины. Избегай иностранных слов типа "masculine", "boundaries", "expectations", "harmonious" - заменяй их русскими эквивалентами: "мужественный", "границы", "ожидания", "гармоничный".
...
КРИТИЧЕСКИ ВАЖНО: Отвечай ИСКЛЮЧИТЕЛЬНО на русском языке! Запрещено использовать иностранные слова. Вместо англицизмов используй русские эквиваленты: "energy" → "энергия", "balance" → "равновесие", "focus" → "сосредоточение", "boundaries" → "границы".
...
ОБЯЗАТЕЛЬНО: Используй ТОЛЬКО русский язык! Избегай иностранных слов. Вместо "energy" говори "энергия", вместо "harmony" - "гармония", вместо "balance" - "равновесие".
...
СТРОГО: Отвечай только на русском языке! Не используй иностранные слова. Применяй русские термины: "harmony" → "гармония", "potential" → "потенциал", "spiritual" → "духовный".
...
ВАЖНО: Используй только русский язык! Избегай англицизмов: "compatibility" → "совместимость", "relationship" → "отношения", "communication" → "общение".
...
ОБЯЗАТЕЛЬНО: Используй исключительно русский язык! Заменяй иностранные слова: "energy" → "энергия", "activities" → "деятельность", "influence" → "влияние", "intuition" → "интуиция".
...
СТРОГО: Отвечай только на русском языке! Не используй иностранную терминологию: "timing" → "время", "favorable" → "благоприятный", "opportunity" → "возможность".
...
ВАЖНО: Отвечай только на русском языке! Используй русские термины: "symbolism" → "символизм", "interpretation" → "интерпретация", "meaning" → "значение".
...
ОБЯЗАТЕЛЬНО: Используй только русский язык! Избегай иностранных слов: "analysis" → "анализ", "aspects" → "аспекты", "interpretation" → "интерпретация".
