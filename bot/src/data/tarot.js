...
const SPREAD_TYPES = {
  single: {
    ...
    positions: [{ name: 'Ваша карта', description: 'Основной ответ на ваш вопрос и текущую ситуацию' }],
    minCards: 1,
    maxCards: 1
  },
  three: {
    ...
    positions: [
      { name: 'Прошлое', description: 'События и энергии, которые привели к текущей ситуации' },
      { name: 'Настоящее', description: 'Текущее состояние дел и ключевые факторы сейчас' },
      { name: 'Будущее', description: 'Тенденции и возможности в ближайшем будущем' }
    ],
    minCards: 3,
    maxCards: 3
  },
  celtic: {
    ...
    positions: [
      { name: 'Текущая ситуация', description: 'Ваше положение и энергии вокруг вас сейчас' },
      { name: 'Препятствие', description: 'Что создает трудности и мешает достижению цели' },
      { name: 'Далекое прошлое', description: 'Корни ситуации и влияние прошлых событий' },
      { name: 'Возможное будущее', description: 'Что может произойти при текущем развитии' },
      { name: 'Возможный исход', description: 'Вероятный результат и его характер' },
      { name: 'Ближайшее будущее', description: 'События и изменения в скором времени' },
      { name: 'Ваш подход', description: 'Как вы воспринимаете и подходите к ситуации' },
      { name: 'Внешние влияния', description: 'Влияние окружающих людей и обстоятельств' },
      { name: 'Надежды и страхи', description: 'Ваши внутренние переживания и ожидания' },
      { name: 'Финальный исход', description: 'Окончательный результат и его последствия' }
    ],
    minCards: 10,
    maxCards: 10
  },
  relationship: {
    ...
    positions: [
      { name: 'Вы', description: 'Ваше эмоциональное состояние и энергия в отношениях' },
      { name: 'Партнер', description: 'Состояние и чувства вашего партнера' },
      { name: 'Отношения', description: 'Динамика и качество связи между вами' },
      { name: 'Препятствия', description: 'Что создает напряжение и мешает гармонии' },
      { name: 'Совет', description: 'Рекомендации для улучшения и развития отношений' }
    ],
    minCards: 5,
    maxCards: 5
  }
